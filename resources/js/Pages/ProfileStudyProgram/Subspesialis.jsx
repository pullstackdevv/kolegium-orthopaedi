...
const DEFAULT_DESCRIPTION = "The subspecialist specialist medical education program for Orthopedics — focusing on general orthopedic surgery & trauma.";
const DEFAULT_STUDENTS = 80;
const DEFAULT_STAFF = 18;
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div className={`w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center flex-shrink-0 ${university.logo ? 'hidden' : ''}`}>
                    <span className="text-primary font-bold text-lg">{university.abbreviation}</span>
                  </div>
                  <div>
                ...
                {/* Sub Title */}
                {university.subTitle && (
                  <p className="text-xs text-gray-500 mb-4">{university.subTitle}</p>
                )}
